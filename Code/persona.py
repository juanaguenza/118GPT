...
again = "Y"
while (again == "Y"):
        persona_file = input("Enter the name of the .json file containing the persona: ") #include the .json such as test.json
        persona_json = open(persona_file) # will work as long as the json file is in ur current working directory
        persona = json.load(persona_json)
        chat_messages.append(persona)
        again = input ("Would you like to enter another .json file? (Y/N): ")
