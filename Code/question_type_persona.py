...
for folder in list_of_folders:
    ...
    try:
        os.mkdir(path_to_json.replace("*.json", "") + "question_type_answers")
    ...
    for f_name in sorted(glob(path_to_json)):
        ...
        answers_file = path_to_json.replace("*.json", "") + "question_type_answers/" + file_num + "_answer.json"
